...
### Fourth Model: Movie + User Effect Model

After running the movie and user effect in separate model:
...
Calculating the value of lambda which produces the minimum value of RMSE:

``` {r optimal-lambda, echo = FALSE, message = FALSE, warning = FALSE}
...
``` {r regularization, eval = FALSE, message=FALSE, warning=FALSE}
rmse_results <- bind_rows(rmse_results,
